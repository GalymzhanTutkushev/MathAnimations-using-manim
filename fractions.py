...
################
        ...
        #     line_group = VGroup(*[
        #                 line.copy().rotate(x*TAU/n,about_point = ORIGIN)
        #                 for x in range(n)
        #             ])
        #     f_group = VGroup(*[
        #                 f16.copy().move_to([2*np.sin(x/n*TAU+PI/n),2*np.cos(x/n*TAU+PI/n),0])
        #                 for x in range(n)
        #             ])
...
################
        ...
        self.play(line8.copy().animate.shift(RIGHT),Write(d28))
        self.play(line8.copy().animate.shift(2*RIGHT),Write(d38))
        self.play(line8.copy().animate.shift(3*RIGHT),Write(d48))
        self.play(line8.copy().animate.shift(4*RIGHT),Write(d58))
        self.wait(3)
        self.restore()
################
