...
class DrawPolygon(Scene):
    def construct(self):
        ...
        FadeOut(line_5), FadeOut(x), FadeOut(y), FadeOut(z),FadeOut(pythag))
        ...
        line_6.set_color(color = BLACK)
        line_7.set_color(color = BLACK)
        line_8.set_color(color = BLACK)
        line_9.set_color(color = BLACK)
        ...
        n_aots = Tex("a^2 + 2ab + b^2 = ")
        
        n_aots.next_to(aos, DOWN)
        n_aots.scale(0.65)

        ao4t = Tex("4\\frac{1 }{2 }(ab) \\quad + ")

        ao4t.next_to(aots, RIGHT)
        ao4t.scale(0.65)

        n_ao4t = Tex("2","(","a","b",") \\quad" ,"+")
        ...
        solve = Tex("\\text{Solve for } c")

        solve.next_to(aots, DOWN)
        solve.scale(0.65)

        solved = Tex("a^2 + b^2 = c^2")

        solved.move_to(UP)
        #solved.scale(0.95)

        solved2 = Tex("a^2 + b^2 = c^2")

        solved2.move_to(UP)

        n_solved = Tex("a^2 + b^2 = c^2")
